					...
					<div class='border-b border-gray-200 shadow'>
						<table class='divide-y divide-gray-300 '>
							...
							<tr class='whitespace-nowrap'
								v-for='item in cmmncd.cmmncdInfo?.cmmncdList?.content'
								:key='item.cmmncd_id'
							>
						...
						<div class='px-5 bg-white py-5 flex flex-col xs:flex-row items-center xs:justify-between'>
							<div class='flex items-center'>
								...
								<button type='button'
										...
										@click='changePage(1)'
								>
									<svg width='9' fill='currentColor' height='6' class='' viewBox='0 0 1792 1792'
...
let helloExample: hello = JSON.parse('{"strval":"helloman", "idx":2}') as hello;
